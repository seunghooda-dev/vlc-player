...
"%PY%" -m py_compile check_imports.py safe.py process_registry.py theme.py settings.py runtime_tools.py diagnostics.py constants.py db_models.py threads.py meters.py video_panel.py right_panel.py main.py
if errorlevel 1 exit /b %errorlevel%
